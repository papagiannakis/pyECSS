""" Entity classes, part of the pyECSS package
    
pyECSS (Entity Component Systems in a Scenegraph) package
@Copyright 2021-2022 Dr. George Papagiannakis
    
The Entity realted classes are the based aggregation of Components in pyECSS, 
...
from pyECSS.Component import Component, ComponentIterator
