"""
System classes, part of the pyECSS package
    
pyECSS (Entity Component Systems in a Scenegraph) package
@Copyright 2021-2022 Dr. George Papagiannakis
    
The System class is the logic-specific processor of different Components in pyECSS,
...
class System(ABC):
    ...
    def apply2RenderMesh(self, renderMesh: pyECSS.Component.RenderMesh, event = None):
        """
        method to be subclassed for  behavioral or logic computation 
    ...
    def apply2BasicTransform(self, basicTransform: pyECSS.Component.BasicTransform, event = None):
        """
        method to be subclassed for  behavioral or logic computation 
        when visits Components. 
...
class TransformSystem(System):
    ...
    def getLocal2World(self, leafComp: pyECSS.Component, topComp=None):
...
class CameraSystem(System):
    ...
    def getRoot2Camera(self, camComp: pyECSS.Component, topComp=None):
    ...
    #then this
    def applyCamera2BasicTransform(self, basicTransform: pyECSS.Component.BasicTransform):
        """
        method to be subclassed for  behavioral or logic computation 
        when visits Components. 
    ...
    def apply2Camera(self, cam: pyECSS.Component.Camera):
        ...
        """
        if (isinstance(cam,pyECSS.Component.Camera)) == False:
